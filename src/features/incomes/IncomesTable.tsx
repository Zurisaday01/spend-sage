...
import { incomesColumns as columns } from './IncomesColumns';
import { useSearchParams } from 'react-router-dom';
import { useGetIncomesTransactionQuery } from '@/services/apiTransactions';
...
const IncomesTable = ({
	...
	let pageNum = searchParams.get('page') ?? 1;
	const queryTitle = searchParams.get('q') ?? '';

	const { data, isLoading, isFetching } = useGetIncomesTransactionQuery({
		page: +pageNum,
		year: selectedYear,
		month: selectedMonth,
		queryTitle,
